...
export default function Header() {
  return (
    <header className="flex flex-col md:flex-row md:justify-between w-full items-center md:items-start border-b-2 pb-6 md:pb-4 print:pb-2 print:border-b">
      <div className="flex flex-col items-center md:items-start space-y-4 md:space-y-2 print:space-y-1">
        <div className="flex flex-col md:flex-row items-center md:items-end space-y-2 md:space-y-0 md:space-x-4 print:space-x-2">
          <h1 className="text-3xl font-bold print:text-2xl">{personalInfo.name}</h1>
          <h2 className="text-xl print:text-base">求职方向：{personalInfo.title}</h2>
        </div>
        <div className="flex flex-col md:flex-row items-center md:items-start space-y-2 md:space-y-0 md:space-x-6 print:space-x-4 print:text-sm">
