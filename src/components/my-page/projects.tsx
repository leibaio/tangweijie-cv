...
const projectsData: ProjectProps[] = [
  {
    ...
    time: "2024.05-至今",
    description:
      "海外小说作者平台，平台作者10000+，涉及 150+ 国家地区用户。接手负责开发核心模块，包括小说管理、大纲编写、书籍表现分析、收入结算、签约和个人信息管理等功能。",
    bulletPoints: [
      "独立完成产品官网的模块化开发，实现响应式布局，使用语义化标签，使用懒加载等进行性能优化",
      "基于 ElementUI 二次封装全局组件库，符合 UI 设计标准",
      "基于 html2canvas 及原生 mouse 事件和定位计算，实现作者自行制作书籍封面功能。增加作者参与度，提高封面设计效率。",
      "研究并实现海外税表 PDF 解析，PDF 字段导入和手动签名功能。显著提升编辑审核效率，缩短处理时间40%",
  ...
  },
  {
    ...
    description:
      "在线小说阅读平台官网。注重 Google 等搜索引擎的 SEO，实现响应式等",
    bulletPoints: [
...

  {
    ...
    description:
      "集成于APP内的借贷页面服务。负责开发授信、借款、还款、基本信息管理、借还记录等核心模块。",
    bulletPoints: [
      "进行组件优化，将页面重复组件如支持银行卡弹框、密码、图像框组件、文件上传组件封装为独立公共组件",
