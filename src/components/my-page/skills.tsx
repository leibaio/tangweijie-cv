  ...
  return (
    <section className="flex flex-col gap-2">
      ...
      <ul className="flex flex-col list-disc list-inside space-y-2">
        <li>
          熟练掌握 HTML5、CSS3、Less、ES6+、TypeScript 等，快速还原需求页面
        </li>
        <li>
          熟练掌握 Vue2/3 (Vue-Router、Pinia、Vuex
          等)、React（Hooks、React-Router 等）
        </li>
        <li>
          熟练掌握常用样式库如
          ElementUI、AntDesign、TailwindCSS、ShadcnUI、Echarts
          等，并能够二次封装
        </li>
        <li>熟悉 Webpack、Vite 等前端工程化工具，完成日常配置开发构建</li>
